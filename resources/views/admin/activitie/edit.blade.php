                        ...
                        <div class="col-md-9">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="desc">{{ __('main.amenities') }}</label>
                                        <select class="select2 form-control form-control-sm" multiple="multiple" name="amenities[]">
                                            @foreach ($Amenities as $key => $amenity)
                                                <option value="{{ $key }}"  {{ in_array($key, $article->amenities) ? 'selected' : '' }} >{{ $amenity }}</option>
                                            @endforeach
                                        </select>                                        
                                    </div>
                                </div>
