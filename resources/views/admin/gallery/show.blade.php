                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" disabled="" value="{{ $media->title }}">
                                    </div>
                                    <div class="form-group">
                                        <label>{{ __('main.Alt Tag') }}</label>
                                        <input type="text" class="form-control form-control-sm" disabled="" value="{{ $media->alt }}">
                                    </div>
                                    <div class="form-group">
                                        <label>{{ __('main.Url') }}</label>
                                        <input type="text" class="form-control form-control-sm" disabled="" value="{{ asset($medias) }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <form action="{{route('admin.gallery.destroy',$id)}}" method="post" class="d-inline">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit" title="Sil" class="btn btn-danger btn-xs float-right ml-2">{{ __('main.Delete') }}</button>
                                    </form>
                                    <a href="{{ route('admin.gallery.edit',$id) }}" class="btn btn-primary btn-xs float-right ml-2">{{ __('main.Edit') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
