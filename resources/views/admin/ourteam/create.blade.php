    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0 text-dark">{{ __('main.AddNewourteam') }}</h4>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route('admin.ourteams.index') }}">{{ __('main.ourteams') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('main.AddNewourteam') }}</li>
                        </ol>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
        ...
        <div class="content">
            <div class="container-fluid">
                <form action="{{ route('admin.ourteams.store') }}" method="post" id="form">
                    @csrf
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @error('role') <small class="ml-auto text-danger">{{ __('main.role') }}</small> @enderror
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="card" id="save-card">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="btn btn-success btn-sm float-right"
                                    id="submitourteam">{{ __('main.Save') }}</a>
                                    <a href="{{ route('admin.ourteams.index') }}" class="btn btn-danger btn-sm float-right mr-2">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
